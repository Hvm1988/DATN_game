...
public class iTween : MonoBehaviour
{
	...
	public static void MoveFrom(GameObject target, Hashtable args)
	{
		...
		else
		{
			...
			if (flag)
			{
				vector2 = target.transform.localPosition; vector = (vector2 );
			}
			else
			{
				vector2 = target.transform.position; vector = (vector2 );
			}
	...
	public static void RotateFrom(GameObject target, Hashtable args)
	{
		...
		if (flag)
		{
			vector2 = target.transform.localEulerAngles; vector = (vector2 );
		}
		else
		{
			vector2 = target.transform.eulerAngles; vector = (vector2 );
		}
