...
namespace AudienceNetwork
{
	...
	{
		public InterstitialAdBridgeListenerProxy(InterstitialAd interstitialAd, AndroidJavaObject bridgedInterstitialAd) : base("com.facebook.ads.InterstitialAdExtendedListener")
		{
		...
		private void onInterstitialActivityDestroyed()
		{
			this.interstitialAd.executeOnMainThread(delegate
			{
				...
				{
					this.interstitialAd.InterstitialAdActivityDestroyed();
				}
			});
		}
