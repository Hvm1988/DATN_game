	...
	public sealed class InterstitialAd : IDisposable
	{
		public InterstitialAd(string placementId)
		{
			...
			if (Application.platform != RuntimePlatform.OSXEditor)
			{
				...
				InterstitialAdBridge.Instance.OnActivityDestroyed(this.uniqueId, this.InterstitialAdActivityDestroyed);
			}
		}
		...
		{
			return string.Format("[InterstitialAd: PlacementId={0}, InterstitialAdDidLoad={1}, InterstitialAdWillLogImpression={2}, InterstitialAdDidFailWithError={3}, InterstitialAdDidClick={4}, InterstitialAdWillClose={5}, InterstitialAdDidClose={6}], InterstitialAdActivityDestroyed={7}]", new object[]
			{
				this.PlacementId,
				...
				this.InterstitialAdActivityDestroyed
			});
		}
